...
public class NeighboursListTest {
    ...
    public void record2() {
        ...
        ViewInteraction floatingActionButton = onView(
                allOf(withId(R.id.favFab), withContentDescription("favoris"),
                        childAtPosition(
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.item_list_name), withText("Caroline"),
                        withParent(withParent(withId(R.id.list_favourite_neighbours))),
                        isDisplayed()));
    ...
    @Test
    public void MyNeighbourList_onClick_displaysDetailActivity() {
